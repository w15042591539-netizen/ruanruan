  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
      <div className="w-96 p-8 rounded-2xl bg-gray-800 shadow-xl">
        <h1 className="text-2xl font-bold text-center mb-6">登录 软软</h1>
        <input
        ...
        <p className="text-center text-sm text-gray-400">
          没有账号？
          <Link to="/register" className="text-pink-400 ml-1 hover:underline">
            立即注册
          </Link>
        </p>
        <p className="text-center text-sm text-gray-500 mt-2">
          <Link to="/chat" className="hover:underline">游客体验</Link>
        </p>
      </div>
    </div>
  );
